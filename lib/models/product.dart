...
List<Product> products = [
  ...
  Product(
    ...
    photos: [
      ...
      AppImages.bootsBeige,
      AppImages.bootsWineRed,
    ],
    colors: [
      ProductColor(name: "Black", color: "#0A070A"),
      ProductColor(name: "Beige", color: "#977460"),
      ProductColor(name: "Wine Red", color: "#582124"),
    ],
  ...
  Product(
    ...
    rating: 4.8,
    photos: [
      AppImages.backpackBrown,
      AppImages.backpackArmyGreen,
      AppImages.backpackKhaki,
    ],
    colors: [
      ProductColor(name: "Brown", color: "#88644C"),
      ProductColor(name: "Army Green", color: "#686359"),
      ProductColor(name: "Khaki", color: "#E5D9C1"),
    ],
    brand: "Arfico Bags",
    material: "100% Cotton",
    category: "Men Bags"
  ...
  Product(
    ...
    colors: [
      ProductColor(name: "A", color: "#64051C"),
      ProductColor(name: "B", color: "#C1C6F9"),
      ProductColor(name: "C", color: "#162369"),
    ],
    brand: "Saha Lanta",
    material: "Wool",
